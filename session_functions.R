...
{
  if (is.null(selected_assessment_id) || is.na(selected_assessment_id) || selected_assessment_id == "" || !is.numeric(as.numeric(selected_assessment_id))) 
    return(warning(paste0("Warning: load_client bad input parameters for selected_assessment_id=",selected_assessment_id)))
