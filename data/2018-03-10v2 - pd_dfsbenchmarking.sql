...
CREATE TABLE "pd_dfsbenchmarking"."clients" (
  ...
  "short_name" varchar(15) COLLATE "pg_catalog"."default",
...
-- Records of clients
-- ----------------------------
INSERT INTO "pd_dfsbenchmarking"."clients" VALUES (1, 0, 'test client', 'test', NULL, NULL, NULL, NULL, 1, '2018-03-09 18:55:04.741104');
...
-- Records of users
-- ----------------------------
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (0, 'SYSTEM', 'SYSTEM', 'SYSTEM', NULL, NULL, 'f', NULL);
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (1, 'MEL', 'FISSAMEL', 'MEL Team', NULL, NULL, 't', NULL);
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (3, 'test1', '$1$aGstpxLZ$wmVnQLxF.70AMpQ51ftFN0', 'Soren test1', NULL, NULL, 't', '2018-03-10 07:46:08.379318');
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (4, 'test2', '$1$YYIcDwCS$0cZ25s4EaWquXYvq96Cs9.', 'Soren test1', NULL, NULL, 't', NULL);
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (5, 'joe', '$1$aTc/PFPD$d8mVat5rcZ/nSK3xXFjQy.', 'Joe Brew', NULL, NULL, 't', '2018-03-10 07:48:50.987934');
...
SELECT setval('"pd_dfsbenchmarking"."assessments_assessment_id_seq"', 2, true);
ALTER SEQUENCE "pd_dfsbenchmarking"."clients_client_id_seq"
OWNED BY "pd_dfsbenchmarking"."clients"."client_id";
SELECT setval('"pd_dfsbenchmarking"."clients_client_id_seq"', 2, true);
