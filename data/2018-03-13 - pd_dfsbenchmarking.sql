...
INSERT INTO "pd_dfsbenchmarking"."assessments" VALUES (1, 1, 'Assessment Name Update 85', '2017-12-18', 1, '2018-03-09 18:55:42.205113');
...
INSERT INTO "pd_dfsbenchmarking"."clients" VALUES (1, 1862, 'Garanti Bankasi', 'Garanti', 'bank', 'NA', 'Istanbul', 'Turkey', 1, '2018-03-09 18:55:04.741104');
...
SELECT setval('"pd_dfsbenchmarking"."assessments_assessment_id_seq"', 59, true);
ALTER SEQUENCE "pd_dfsbenchmarking"."clients_client_id_seq"
OWNED BY "pd_dfsbenchmarking"."clients"."client_id";
SELECT setval('"pd_dfsbenchmarking"."clients_client_id_seq"', 17, true);
