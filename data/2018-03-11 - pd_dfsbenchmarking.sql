...
-- ----------------------------
INSERT INTO "pd_dfsbenchmarking"."assessments" VALUES (1, 1, 'test assessment', '2017-10-15', 1, '2018-03-09 18:55:42.205113');
...
-- Records of clients
-- ----------------------------
INSERT INTO "pd_dfsbenchmarking"."clients" VALUES (11, 200032, 'New Bank Co.', 'NBC', 'Bank', '111 Main St.', 'Anytown', 'USA', 1, '2018-03-10 16:32:53.578021');
...
INSERT INTO "pd_dfsbenchmarking"."clients" VALUES (1, 0, 'Garanti Bankasi', 'Garanti', 'bank', NULL, 'Istanbul', 'Turkey', 1, '2018-03-09 18:55:04.741104');
...
-- Records of users
-- ----------------------------
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (0, 'SYSTEM', 'SYSTEM', 'SYSTEM', NULL, NULL, 'f', NULL, NULL, 'f');
...
INSERT INTO "pd_dfsbenchmarking"."users" VALUES (1, 'MEL', '$1$9FLfnwld$amkkGyaJvBpW3QT5VEzC6.', 'MEL Team', NULL, NULL, 't', '2018-03-10 23:19:11.620773', 'ecbdc2ee-7d74-460b-aaea-c2309a970285', 'f');
...
-- ----------------------------
DROP FUNCTION IF EXISTS "pd_dfsbenchmarking"."client_edit"("v_session_id" uuid, "v_client_id" int4, "v_ifc_client_id" int4, "v_name" varchar, "v_short_name" varchar, "v_firm_type" varchar, "v_address" varchar, "v_city" varchar, "v_country" varchar);
CREATE OR REPLACE FUNCTION "pd_dfsbenchmarking"."client_edit"("v_session_id" uuid, "v_client_id" int4, "v_ifc_client_id" int4, "v_name" varchar, "v_short_name" varchar, "v_firm_type" varchar, "v_address" varchar, "v_city" varchar, "v_country" varchar)
  RETURNS "pg_catalog"."int4" AS $BODY$
...
CREATE VIEW "pd_dfsbenchmarking"."view_client_listing" AS  SELECT clients.created_by_user_id,
  ...
  GROUP BY clients.address, clients.created_by_user_id, clients.client_id, clients.ifc_client_id, COALESCE(clients.short_name, clients.name), clients.city, clients.country, users.name
