...
SELECT pg_catalog.setval('pd_dfsbenchmarking.assessments_assessment_id_seq', 62, true);
...
SELECT pg_catalog.setval('pd_dfsbenchmarking.clients_client_id_seq', 20, true);
...
1	MEL	$1$9FLfnwld$amkkGyaJvBpW3QT5VEzC6.	MEL Team	\N	\N	t	2018-03-14 06:26:13.653763	1ad967d0-286d-4dc2-9124-f7bcbfb63f0c	f
\.
