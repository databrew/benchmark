          ...
          box(#title = 'Example',
            fluidPage(
              fluidRow(column(3),
                       ...
                       column(3)),
              fluidRow(column(4,
                              h4(span('Formative staffing', style = "color:black"), span('(score 1-3)', style = "color:red")),
                              p('The bank is poorly-staffed.')),
                       column(4,
                              h4(span('Emerging staffing', style = "color:black"), span('(score 4-5)', style = "color:yellow")),
                              p('The bank has sufficient staff.')),
                       column(4,
                              h4(span('Developed staffing', style = "color:black"), span('(score 6-7)', style = "color:green")),
